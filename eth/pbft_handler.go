...
func newPBFTProtocolManager(config *params.ChainConfig, mode downloader.SyncMode, networkId int, maxPeers int, mux *event.TypeMux, txpool txPool, engine consensus.PBFT, blockchain *core.BlockChain, chaindb ethdb.Database) (*pbftProtocolManager, error) {
